  ...
  async fetch(request, env) {
    ...
    try {
      ...
      const fields = {
        ...
        'SIP 1-1': gameData.sip1Survey?.includes(0) ? '1' : '',
        'SIP 1-2': gameData.sip1Survey?.includes(1) ? '2' : '',
        'SIP 1-3': gameData.sip1Survey?.includes(2) ? '3' : '',
        'SIP 1-4': gameData.sip1Survey?.includes(3) ? '4' : '',
        'SIP 1-5': gameData.sip1Survey?.includes(4) ? '5' : '',
        'SIP 1-6': gameData.sip1Survey?.includes(5) ? '6' : '',
        'SIP 2-1': gameData.sip2Survey?.includes(0) ? '7' : '',
        'SIP 2-2': gameData.sip2Survey?.includes(1) ? '8' : '',
        'SIP 2-3': gameData.sip2Survey?.includes(2) ? '9' : '',
        'SIP 2-4': gameData.sip2Survey?.includes(3) ? '10' : '',
        'SIP 2-5': gameData.sip2Survey?.includes(4) ? '11' : '',
        'SIP 2-6': gameData.sip2Survey?.includes(5) ? '12' : '',
